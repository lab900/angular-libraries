export const formsTranslations = {
  en: {
    ...
    'forms.error.minlength':
      'This field should contain at least {{requiredLength}} characters.',
    'forms.error.maxlength':
      'This field should contain at most {{requiredLength}} characters.',
  ...
  nl: {
    ...
    'forms.error.minlength':
      'Dit moet minstens {{requiredLength}} karakters bevatten.',
    'forms.error.maxlength':
      'Dit moet minstens {{requiredLength}} karakters bevatten.',
    'forms.error.min': 'Dit moet minstens {{min}} zijn.',
    'forms.error.max': 'Dit mag maximaal {{max}} zijn.',
    'forms.error.requireMatch': 'Selecteer een waarde.',
