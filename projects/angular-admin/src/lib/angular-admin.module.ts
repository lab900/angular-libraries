...
@NgModule({
  declarations: [AdminPageComponent, AdminTableComponent, AdminEditComponent, AlertDialogComponent, ConfirmationDialogComponent, DateDisplayComponent, TextDisplayComponent],
  imports: [
    CommonModule,
    MatTableModule,
    MatPaginatorModule,
