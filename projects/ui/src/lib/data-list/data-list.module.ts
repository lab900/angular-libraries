...
@NgModule({
  ...
  imports: [CommonModule, MatCardModule, MatButtonModule, MatIconModule, FlexLayoutModule, TranslateModule, MatMenuModule, Lab900SharingModule, MatProgressSpinnerModule, MatPaginatorModule],
})
