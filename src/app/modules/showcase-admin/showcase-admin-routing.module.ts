...
const routes: Routes = [
  ...
  new ShowcaseRoute('admin-page', 'Admin Page', [new ShowcaseExample(AdminPageExampleComponent, 'Admin Page', '', ['TS', 'HTML'])]),
  new ShowcaseRoute('translatable-admin-page', 'Translatable Admin Page', [
    new ShowcaseExample(TranslatableAdminPageExampleComponent, 'Translatable Admin Page', '', ['TS', 'HTML']),
  ]),
];
