...
import { MomentExampleComponent } from './examples/moment-example/moment-example.component';
...
const routes: Routes = [
  ...
  new ShowcaseRoute('moment-container', 'Moment Container', [new ShowcaseExample(MomentExampleComponent, 'Moment Container', ['TS'], '')]),
];
